...
export const missions: Mission[] = [
  ...
  },
  {
    ...
    sectorColor: "#e65100",
    title: "Tesla",
    subtitle: "Manufacturing Engineering Intern · LFP Cell Manufacturing · Jun 2026 – Aug 2026",
    status: "active",
    landmark: "Tesla's LFP factory with battery Cell Manufacturing lines and electric arcs",
    position: { x: -1500, y: -1180 },
    date: "Jun 2026 – Aug 2026",
    chronoOrder: 202608,
    skills: ["Manufacturing Engineering", "Battery Cell Manufacturing", "Automation", "Python", "Lean Six Sigma"],
    details:
      "Interned at Tesla's LFP factory, working on LFP Cell Manufacturing for Megapacks.\n\nFocused on Cell Manufacturing processes, production line optimization, and automation systems for utility-scale energy storage.",
    emoji: "⚡",
    color: "#e65100",
    logo: "/logo/tesla.jpg",
    gravityMass: 1000,
