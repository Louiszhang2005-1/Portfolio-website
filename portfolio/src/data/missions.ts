...
export const missions: Mission[] = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    date: "May–Aug 2025",
    chronoOrder: 202505,
    skills: ["Water Quality Testing", "Data Analysis", "Environmental Engineering", "Python", "GIS"],
    details:
  ...
  },
  {
    ...
    sectorColor: "#e65100",
    title: "Tesla",
    subtitle: "Manufacturing Engineering Intern · LFP Cell Engineering · Jun 2026 – Aug 2026",
    status: "active",
    landmark: "Tesla's LFP factory with battery cell production lines and electric arcs",
    position: { x: -1500, y: -1180 },
    date: "Jun 2026 – Aug 2026",
    chronoOrder: 202606,
    skills: ["Battery Cell Manufacturing", "PLC", "HMI Design", "Equipment Design", "Root Cause Analysis", "Python"],
    details:
      "Interned at Tesla's LFP factory on the LFP Cell Engineering team for Megapack battery cells.\n\nWorked on cell production processes, PLC/HMI controls, equipment design, and root-cause analysis for utility-scale energy storage lines.",
    emoji: "⚡",
    color: "#e65100",
    logo: "/logo/tesla.jpg",
    gravityMass: 1000,
